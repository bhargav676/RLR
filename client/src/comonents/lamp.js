  ...
  return (
    (<LampContainer>
      <motion.h1
        ...
        className=" bg-gradient-to-br from-white py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl">
        RLR <br /> 
      </motion.h1>
    </LampContainer>)
  );
...
export const LampContainer = ({
  ...
  return (
    (<div
      ...
      <div
        ...
        <div
          className="absolute top-1/3 h-48 w-full translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
        <div
  ...
  className="
    ...
    translate-y-[-530px] 
    md:translate-y-[-430px] 
    lg:translate-y-[-430px] 
    xl:translate-y-[-430px]"
>
